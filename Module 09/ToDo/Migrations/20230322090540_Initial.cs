    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Job Number 1", "Ticket 1", 7, 1, "todo" },
                    { 3, "Job Number 3", "Ticket 3", 4, 2, "todo" },
                    { 5, "Job Number 5", "Ticket 5", 3, 3, "todo" },
                    { 7, "Job Number 7", "Ticket 7", 5, 4, "todo" },
                    { 9, "Job Number 9", "Ticket 9", 5, 5, "todo" },
                    { 2, "Job Number 2", "Ticket 2", 6, 1, "inprog" },
                    { 4, "Job Number 4", "Ticket 4", 2, 2, "inprog" },
                    { 6, "Job Number 6", "Ticket 6", 7, 3, "inprog" },
                    { 8, "Job Number 8", "Ticket 8", 5, 4, "inprog" },
